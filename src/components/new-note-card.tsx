  ...
  return (
    <Dialog.Root onOpenChange={handleOpenModal}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed flex flex-col overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md outline-none">
